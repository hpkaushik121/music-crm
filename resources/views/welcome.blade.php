...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="{{asset('css/chat-app-page.css')}}" rel="stylesheet">
...
<body class="fixed-layout skin-green">
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="http://eliteadmin.themedesigner.in/demos/bt4/music/index.html">
                        <!-- Logo icon --><b>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="af995f01-d223-7ae2-c6e1-f2247bfcc0e1">
                                            <!-- Message -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-right animated bounceInDown" aria-labelledby="2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="68407d5f-d9ef-50d8-2de6-7b9332467aed">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{asset('images/1.jpg')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{asset('images/2.jpg')}}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{asset('images/3.jpg')}}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{asset('images/4.jpg')}}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        <div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="{{asset('images/img1.jpg')}}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('images/img2.jpg')}}" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                ...
                                <!-- text-->
                                <a href="/profile/contact-details#settings" class="dropdown-item"><i class="ti-settings"></i> Account Setting</a>
                                <!-- text-->
                                <div class="dropdown-divider"></div>
                                <!-- text-->
        ...
        <aside class="left-sidebar">
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar ps ps--theme_default ps--active-y" data-ps-id="0f8195d8-8930-a4ba-fcc1-beb0a4ee2107">
                <!-- Sidebar navigation-->
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        {{-- <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('images/1.jpg')}}" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Apps</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/apps/calender">Calendar</a></li>
                                <li><a href="/apps/chat">Chat app</a></li>
                                <li><a href="/apps/tickets">Support Ticket</a></li>
                                <li><a href="/apps/contact">Contact / Employee</a></li>
                                <li><a href="/apps/contact-grid">Contact Grid</a></li>
                                <li><a href="/apps/contact-details">Contact Detail</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Ui Elements <span class="badge badge-pill badge-primary text-white ml-auto">25</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/Ui-Elements/cards">Cards</a></li>
                                <li><a href="/Ui-Elements/User-Card">User Cards</a></li>
                                <li><a href="/Ui-Elements/buttons">Buttons</a></li>
                                <li><a href="/Ui-Elements/modals">Modals</a></li>
                                <li><a href="/Ui-Elements/tabs">Tab</a></li>
                                <li><a href="/Ui-Elements/Tooltip-Popover">Tooltip &amp; Popover</a></li>
                        ...
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('images/1.jpg')}}" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/profile/contact-details#profile"><i class="ti-user"></i> My Profile</a></li>
                                <li><a href="/profile/contact-details#settings"><i class="ti-settings"></i> Account Setting</a></li>
                                <li><a href="javascript:void(0)"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="/dashboard" aria-expanded="false"><i class="ti-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
            ...
            <div class="ps__scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 634px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 276px;"></div></div></div>
            <!-- End Sidebar scroll-->
        </aside>
        <!-- ============================================================== -->
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" style="min-height: 642px;">
            <!-- ============================================================== -->
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- .right-sidebar -->
                <div class="right-sidebar ps ps--theme_default" data-ps-id="04a7d810-8494-fbb7-8bde-c57c2909c19d">
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/1.jpg')}}" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/2.jpg')}}" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/3.jpg')}}" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/4.jpg')}}" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/5.jpg')}}" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/6.jpg')}}" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/7.jpg')}}" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('images/8.jpg')}}" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="jp_container_N" class="bg-dark jp-video-270p">
                    <div class="jp-type-playlist">
                            ...
                            <div class="jp-interface">
                                <div class="jp-controls">
                                    ...
                                    <div>
                                        ...
                                        <a class="jp-pause" style="display: none;"><i class="fa fa-pause-circle fa-2x"></i></a>
                                    </div>
                                    <div><a class="jp-next"><i class="fa fa-step-forward"></i></a></div>
                                    <div class="jp-progress hidden-xs">
                                        <div class="jp-seek-bar" style="width: 100%;">
                                            <div class="jp-play-bar play-progress" style="width: 0%;">
                                            </div>
                                            <div class="jp-current-time current-time text-white">00:00</div>
                                            <div class="jp-title text-white">Sun raha hai na tu</div>
                                            <div class="jp-duration duration text-white">05:14</div>
                                        </div>
                                    </div>
                                    <div class="hidden-xs hidden-sm">
                                        <a class="jp-mute" title="mute"><i class="fa fa-volume-up"></i></a>
                                        <a class="jp-unmute" title="unmute" style="display: none;"><i class="fa fa-volume-off"></i></a>
                                    </div>
                        ...
                        <div class="jp-playlist dropup" id="playlist">
                            <ul class="dropdown-menu bg-inverse m-b-0" style="display: block;"><li class="jp-playlist-current"><div><a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item jp-playlist-current" tabindex="0">Sun raha hai na tu <span class="jp-artist">by Shreya ghosal</span></a></div></li><li><div><a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item" tabindex="0">Shubhaarambh <span class="jp-artist">by Shreya ghosal</span></a></div></li><li><div><a href="javascript:;" class="jp-playlist-item-remove">×</a><a href="javascript:;" class="jp-playlist-item" tabindex="0">title2 <span class="jp-artist">by Shreya ghosal</span></a></div></li></ul>
                        </div>
