                                ...
                                <div class="chat-left-aside">
                                    ...
                                    <div class="chat-left-inner">
                                        ...
                                        <ul class="chatonline style-none ">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="active"><img src="{{asset('images/users/2.jpg')}}" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="chat-rbox">
                                        <ul class="chat-list p-3">
                                            ...
                                            <li class="reverse">
                                                ...
                                                <div class="chat-img"><img src="{{asset('images/users/5.jpg')}}" alt="user" /></div>
                                            </li>
                                            <!--chat Row -->
                                            <li class="reverse">
                                                <div class="chat-content">
